# def save_bill():
#         file_name=filedialog.asksaveasfilename(defaultextension=".txt",filetypes=[("textfiles",".txt"),("all fies","*.*")])
#         if file_name:
#             with open(file_name,"w") as file:
#                 file.write(bill_label.cget("text"))
#             messagebox.showinfo("saved","bill saved successfully.")
    # save_button = ttk.Button(input_frame, text="Save Bill", command=save_bill)
...
# original_inventory = spare_parts_inventory.copy()
	...
	# #input of customer name and vehicle
